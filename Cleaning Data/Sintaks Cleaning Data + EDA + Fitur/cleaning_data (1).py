...
## Data Dictionary Variabel Utama
...
## Data Dictionary Variabel Hasil Feature Engineering

| No | Nama Variabel          | Tipe Data         | Deskripsi                                           | Keterangan                                                                        |
| -: | ---------------------- | ----------------- | --------------------------------------------------- | --------------------------------------------------------------------------------- |
|  1 | `pulse_pressure`       | Integer/Float     | Selisih antara tekanan darah sistolik dan diastolik | `systolic_bp - diastolic_bp`                                                      |
|  2 | `blood_pressure_ratio` | Float             | Rasio antara tekanan darah sistolik dan diastolik   | `systolic_bp / diastolic_bp`                                                      |
|  3 | `hypertension_stage`   | Integer/Kategorik | Kategori tingkat hipertensi pasien                  | Dibuat berdasarkan tekanan darah sistolik dan diastolik                           |
|  4 | `bmi_category`         | Kategorik         | Kategori BMI pasien                                 | Mengelompokkan BMI ke dalam kategori tertentu                                     |
|  5 | `cholesterol_category` | Kategorik         | Kategori kadar kolesterol pasien                    | Dibuat berdasarkan rentang kadar kolesterol                                       |
|  6 | `activity_level`       | Kategorik         | Kategori tingkat aktivitas fisik pasien             | Dibuat berdasarkan aktivitas fisik atau jumlah langkah harian                     |
|  7 | `sleep_category`       | Kategorik         | Kategori durasi tidur pasien                        | Mengelompokkan durasi tidur pasien                                                |
|  8 | `alcohol_category`     | Kategorik         | Kategori konsumsi alkohol pasien                    | Dibuat berdasarkan jumlah unit alkohol per minggu                                 |
...
| 11 | `age_group`            | Kategorik         | Kelompok usia pasien                                | Contoh: `<30`, `30-39`, `40-49`, `50-59`, `60-69`, `70-79`, dan `80+`             |
